...
> Sprint 6 (16-08-2026) — ✅ Approved & Active. M0–M5 selesai; E2E Sprint 6 **38/38 PASS** + regression Sprint 5 25/25 PASS; menunggu audit & release (M7). Detail: `.docs/sprint-6.md`, `.docs/e2e/sprint-6-verification.md`.
